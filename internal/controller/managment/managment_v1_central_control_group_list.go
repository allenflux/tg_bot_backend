...
func (c *ControllerV1) CentralControlGroupList(ctx context.Context, req *v1.CentralControlGroupListReq) (res *v1.CentralControlGroupListRes, err error) {
	...
	// Prepare response
	res = &v1.CentralControlGroupListRes{
